/**
 * Lightweight icon set using inline SVG.
 *
 * Avoids pulling in a heavyweight icon library — we only need a handful of
 * well-known glyphs.
 */
...
export const FolderOpen = makeIcon(
  <>
    <path d="m6 14 1.5-2.5A2 2 0 0 1 9.2 10.5H20a2 2 0 0 1 1.95 2.45l-1.0 4.5A2 2 0 0 1 18.95 19H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h6a2 2 0 0 1 2 2v2" />
  </>,
);
...
export const Loader = makeIcon(
  <line x1="12" y1="2" x2="12" y2="6" />,
);
export const FolderCog = makeIcon(
  <>
...
export const Play = makeIcon(<polygon points="5 3 19 12 5 21 5 3" />);

export const Settings2 = makeIcon(
  <>
    <circle cx="12" cy="12" r="3" />
...
export const FlipHorizontal2 = makeIcon(
  <>
    <path d="m3 7 5 5-5 5V7z" />
    <path d="M21 17l-5-5 5-5v10z" />
...
/** GitHub mark (§22) — filled path; the stroke defaults are overridden. */
